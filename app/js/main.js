...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function htmlCityItem(data) {
    return "\n    <div class=\"locations-dropdown__citys\">\n      <span class=\"locations-dropdown__city-name\">".concat(data.areas[0].name ? data.areas[0].name : '', "</span>\n      <span class=\"locations-dropdown__city-state\">").concat(data.name, "</span>\n    </div>\n    ");
  }
  ...
  navButtons.forEach(function (btn, index) {
    ...
    btn.addEventListener('click', function () {
      ...
      navListWrapper.style.cssText = "transform:translateX(".concat(-sumWidth - -90, "px);");
